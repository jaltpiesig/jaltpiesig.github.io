...
<div class="officers-bio-grid" style="display: grid; grid-template-columns: 1fr; gap: 20px; margin-bottom: 35px;">
  ...
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 8px; padding: 22px;">
    <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px;">DARREN KINSMAN</h2>
    <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px;">PIE President</h3>
    ...
    <p style="font-size: 0.9rem; line-height: 1.6; color: #333; margin-top: 10px;">
  ...
  <!-- Kevin Bergman -->
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 8px; padding: 22px;">
    <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px;">KEVIN BERGMAN</h2>
    <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px;">Vice President & Drama Chair</h3>
    <p style="font-size: 0.9rem; line-height: 1.6; color: #333;">
  ...
  <!-- Kim Rockell -->
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 8px; padding: 22px;">
    <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px;">KIM ROCKELL</h2>
    <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px;">Music Chair</h3>
    <p style="font-size: 0.9rem; line-height: 1.6; color: #333;">
  ...
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 8px; padding: 22px;">
    <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px;">ANTHONY BRIAN GALLAGHER</h2>
    <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px;">Assistant Program Chair</h3>
    <p style="font-size: 0.9rem; line-height: 1.6; color: #333;">
  ...
  <!-- David Kluge -->
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 8px; padding: 22px;">
    <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px;">DAVID KLUGE</h2>
    <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px;">PIE Founder, Membership Chair, Oral Interpretation Chair, Debate Chair, Conferences Chair</h3>
    <p style="font-size: 0.9rem; line-height: 1.6; color: #333;">
  ...
  <!-- Zach Strickland -->
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 8px; padding: 22px;">
    <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px;">ZACH STRICKLAND</h2>
    <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px;">PIE Drama Chair</h3>
    <p style="font-size: 0.9rem; line-height: 1.6; color: #333;">
  ...
  <!-- Fatima Mei Ataka -->
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 8px; padding: 22px;">
    <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px;">FATIMA MEI ATAKA</h2>
    <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px;">AET Liaison</h3>
    <p style="font-size: 0.9rem; line-height: 1.6; color: #333;">
  ...
  <!-- Brett Edman -->
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 8px; padding: 22px;">
    <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px;">BRETT EDMAN</h2>
    <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px;">AET Liaison</h3>
    <p style="font-size: 0.9rem; line-height: 1.6; color: #333;">
