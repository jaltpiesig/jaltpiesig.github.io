...
<!-- Custom Styling for Circular Profile Images -->
<style>
  .officer-avatar-main {
    width: 100px;
    height: 100px;
...
<div class="hero-black-box" style="margin-bottom: 30px;">
  <div>
    <h1 style="color: #ffffff; font-size: 2rem; font-weight: bold;">MEET THE OFFICERS</h1>
...
<div class="officers-bio-grid" style="display: grid; grid-template-columns: 1fr; gap: 20px; margin-bottom: 35px;">
  ...
  <div class="officer-card-wrapper">
    ...
    <div class="officer-card-content">
      <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px; margin-top: 0;">DARREN KINSMAN</h2>
      <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px; margin-top: 0;">PIE President</h3>
  ...
  <div class="officer-card-wrapper">
    ...
    <div class="officer-card-content">
      <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px; margin-top: 0;">KEVIN BERGMAN</h2>
      <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px; margin-top: 0;">Vice President & Drama Chair</h3>
      <p style="font-size: 0.9rem; line-height: 1.6; color: #333; margin: 0;">
  ...
  <div class="officer-card-wrapper">
    ...
    <div class="officer-card-content">
      <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px; margin-top: 0;">KIM ROCKELL</h2>
      <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px; margin-top: 0;">Music Chair</h3>
      <p style="font-size: 0.9rem; line-height: 1.6; color: #333; margin: 0;">
  ...
  <div class="officer-card-wrapper">
    ...
    <div class="officer-card-content">
      <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px; margin-top: 0;">ANTHONY BRIAN GALLAGHER</h2>
      <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px; margin-top: 0;">Assistant Program Chair</h3>
      <p style="font-size: 0.9rem; line-height: 1.6; color: #333; margin: 0;">
  ...
  <div class="officer-card-wrapper">
    ...
    <div class="officer-card-content">
      <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px; margin-top: 0;">DAVID KLUGE</h2>
      <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px; margin-top: 0;">PIE Founder, Membership Chair, Oral Interpretation Chair, Debate Chair, Conferences Chair</h3>
      <p style="font-size: 0.9rem; line-height: 1.6; color: #333; margin: 0;">
  ...
  <div class="officer-card-wrapper">
    ...
    <div class="officer-card-content">
      <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px; margin-top: 0;">ZACH STRICKLAND</h2>
      <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px; margin-top: 0;">PIE Drama Chair</h3>
      <p style="font-size: 0.9rem; line-height: 1.6; color: #333; margin: 0;">
  ...
  <div class="officer-card-wrapper">
    ...
    <div class="officer-card-content">
      <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px; margin-top: 0;">FATIMA MEI ATAKA</h2>
      <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px; margin-top: 0;">AET Liaison</h3>
      <p style="font-size: 0.9rem; line-height: 1.6; color: #333; margin: 0;">
  ...
  <div class="officer-card-wrapper">
    ...
    <div class="officer-card-content">
      <h2 style="color: var(--burgundy-accent); font-size: 1.25rem; font-weight: bold; margin-bottom: 2px; margin-top: 0;">BRETT EDMAN</h2>
      <h3 style="color: var(--text-dark); font-size: 0.95rem; font-weight: bold; margin-bottom: 12px; margin-top: 0;">AET Liaison</h3>
      <p style="font-size: 0.9rem; line-height: 1.6; color: #333; margin: 0;">
...
<!-- Compact Additional Officers Directory Grid (With Circular Top Profile Pictures) -->
<h2 class="section-title" style="margin-top: 30px; margin-bottom: 15px;">ADDITIONAL OFFICERS & ROLES</h2>

<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 15px; margin-bottom: 35px;">

  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 6px; padding: 15px; text-align: center;">
    <img src="{{ site.baseurl }}/assets/images/officers/diaz.jpeg" alt="Max Diaz" class="officer-avatar-sub">
    <strong style="color: var(--burgundy-accent); display: block; font-size: 1rem;">MAX DIAZ</strong>
  ...
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 6px; padding: 15px; text-align: center;">
    ...
    <strong style="color: var(--burgundy-accent); display: block; font-size: 1rem;">ASHLEY FORD-MIHASHI</strong>
  ...
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 6px; padding: 15px; text-align: center;">
    ...
    <strong style="color: var(--burgundy-accent); display: block; font-size: 1rem;">PHILIP HEAD</strong>
  ...
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 6px; padding: 15px; text-align: center;">
    ...
    <strong style="color: var(--burgundy-accent); display: block; font-size: 1rem;">VIVIAN BUSSINGUER-KHAVARI</strong>
  ...
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 6px; padding: 15px; text-align: center;">
    ...
    <strong style="color: var(--burgundy-accent); display: block; font-size: 1rem;">YUKARI SAIKI</strong>
  ...
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 6px; padding: 15px; text-align: center;">
    ...
    <strong style="color: var(--burgundy-accent); display: block; font-size: 1rem;">GORDON REES</strong>
  ...
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 6px; padding: 15px; text-align: center;">
    ...
    <strong style="color: var(--burgundy-accent); display: block; font-size: 1rem;">JAMES HIGA</strong>
  ...
  <div style="background: #ffffff; border: 1px solid var(--border-subtle); border-radius: 6px; padding: 15px; text-align: center;">
    ...
    <strong style="color: var(--burgundy-accent); display: block; font-size: 1rem;">DAWN KOBAYASHI</strong>
