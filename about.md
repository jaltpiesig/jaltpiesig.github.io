...
<!-- Top Hero Black Box matching layout styling -->
<div class="hero-black-box">
<div class="about-hero-text">
<h1 style="color: #ffffff; font-size: 2rem; margin-bottom: 12px; font-weight: bold;">About US</h1>
...
<p class="hero-intro-text" style="margin-top: 10px;">
...
<!-- Section Sub-Navigation Menu Bar from PDF -->
<div style="display: flex; gap: 15px; margin-bottom: 25px; flex-wrap: wrap;">
<a href="#what-we-are" style="background: var(--dark-box-bg); color: #ffffff; padding: 10px 18px; border-radius: 4px; text-decoration: none; font-weight: bold; font-size: 0.85rem;">WHAT WE ARE</a>
<a href="#what-we-do" style="background: var(--dark-box-bg); color: #ffffff; padding: 10px 18px; border-radius: 4px; text-decoration: none; font-weight: bold; font-size: 0.85rem;">WHAT WE DO</a>
<a href="/officers/" style="background: var(--dark-box-bg); color: #ffffff; padding: 10px 18px; border-radius: 4px; text-decoration: none; font-weight: bold; font-size: 0.85rem;">PIE SIG OFFICERS</a>
<a href="#" style="background: var(--dark-box-bg); color: #ffffff; padding: 10px 18px; border-radius: 4px; text-decoration: none; font-weight: bold; font-size: 0.85rem;">CONSTITUTION</a>
</div>

<!-- WHAT WE ARE Section -->
<div id="what-we-are" style="background: #ffffff; padding: 28px; border-radius: 8px; border: 1px solid var(--border-subtle); margin-bottom: 30px;">
<h2 class="section-title">WHAT WE ARE</h2>
<p style="font-style: italic; margin-bottom: 12px; color: #555;">
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; line-height: 1.6; font-size: 0.92rem;">
<div>
...
<!-- WHAT WE DO Section -->
<div id="what-we-do" style="background: #ffffff; padding: 28px; border-radius: 8px; border: 1px solid var(--border-subtle); margin-bottom: 30px;">
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; line-height: 1.6; font-size: 0.9rem;">
<div>
