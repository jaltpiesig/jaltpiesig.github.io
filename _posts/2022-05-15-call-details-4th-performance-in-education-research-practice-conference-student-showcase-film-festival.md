---
title: "Call & Registration: 4th Performance in Education: Research & Practice Conference/Student Showcase/Film Festival"
date: 2022-05-15
categories: 
  - "events"
---
...
<div style="margin-bottom: 30px;">
  <div style="display: flex; gap: 20px; flex-wrap: wrap; align-items: flex-start;">
    <img src="{{ '/assets/images/Kinsman-BW-2022-06-03-242x300.png' | relative_url }}" alt="Darren Kinsman" style="width: 120px; height: auto; border-radius: 8px; border: 1px solid #e2e8f0;">
    <div style="flex: 1; min-width: 260px;">
...
<div style="margin-bottom: 30px;">
  <div style="display: flex; gap: 20px; flex-wrap: wrap; align-items: flex-start;">
    <img src="{{ '/assets/images/image-290x300.png' | relative_url }}" alt="Greg Lewis" style="width: 120px; height: auto; border-radius: 8px; border: 1px solid #e2e8f0;">
    <div style="flex: 1; min-width: 260px;">
...
<div style="margin-bottom: 30px;">
  <div style="display: flex; gap: 20px; flex-wrap: wrap; align-items: flex-start;">
    <img src="{{ '/assets/images/Lisa-M.-Hunsberger-249x300.jpeg' | relative_url }}" alt="Lisa M. Hunsberger" style="width: 120px; height: auto; border-radius: 8px; border: 1px solid #e2e8f0;">
    <div style="flex: 1; min-width: 260px;">
...
<div style="margin-bottom: 30px;">
  <div style="display: flex; gap: 20px; flex-wrap: wrap; align-items: flex-start;">
    <img src="{{ '/assets/images/JTB1RabPaterson-edited-300x300.jpeg' | relative_url }}" alt="Rab Paterson" style="width: 120px; height: auto; border-radius: 8px; border: 1px solid #e2e8f0;">
    <div style="flex: 1; min-width: 260px;">
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px;">
  ...
  <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px;">
    <img src="{{ '/assets/images/Stephen-Pottinger-200x300.jpg' | relative_url }}" alt="Stephen Pottinger" style="width: 80px; height: auto; border-radius: 6px; float: left; margin-right: 12px;">
  ...
  <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px;">
    <img src="{{ '/assets/images/C17C77DD-987A-485D-AD1A-E6A15A3448C5_1_201_a-271x300.jpeg' | relative_url }}" alt="Kim Rockell" style="width: 80px; height: auto; border-radius: 6px; float: left; margin-right: 12px;">
...
<div style="display: flex; gap: 12px; flex-wrap: wrap; justify-content: center; margin-bottom: 30px;">
  <img src="{{ '/assets/images/Screen-Shot-2022-05-14-at-13.14.19-1024x689.png' | relative_url }}" alt="Gran Piatto Entrance" style="width: 240px; height: auto; border-radius: 6px; border: 1px solid #e2e8f0;">
  <img src="{{ '/assets/images/Screen-Shot-2022-05-14-at-13.15.07-842x1024.png' | relative_url }}" alt="Gran Piatto Interior" style="width: 240px; height: auto; border-radius: 6px; border: 1px solid #e2e8f0;">
  <img src="{{ '/assets/images/image-1024x678.jpeg' | relative_url }}" alt="Past Banquet Attendees" style="width: 240px; height: auto; border-radius: 6px; border: 1px solid #e2e8f0;">
</div>
