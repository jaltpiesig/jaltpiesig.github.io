---
title: "The 5th Performance in Education: Research & Practice PIE SIG in Gero (Gifu) Conference (July 22-23, 2023)"
date: 2023-03-15
categories: 
  - "events"
---
...
<div align="center" style="margin: 40px 0 30px 0;">
  <span style="background-color: #fef3c7; color: #b45309; font-size: 14px; font-weight: bold; padding: 6px 14px; border-radius: 20px; text-transform: uppercase; letter-spacing: 1px;">Summer Event</span>
  <h1 style="margin-top: 15px; margin-bottom: 10px; font-size: 2.2em; border: none;">5th Performance in Education Conference in Gero</h1>
...
Join us for the <strong>5th Performance in Education: Research & Practice Conference</strong> on <strong>July 22–23, 2023</strong> in the hot spring resort town of Gero, Gifu Prefecture. This summer conference brings together researchers, educators, and practitioners to explore performance-based language learning through speech, drama, debate, music, and oral interpretation.
</p>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 16px;">
  ...
  <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px;">
    ...
    <p style="margin: 6px 0 0 0; font-weight: 600; color: #0f172a; font-size: 1.05em;">July 22–23, 2023</p>
...
<div style="background-color: #fff7ed; border-left: 4px solid #f97316; border-radius: 4px; padding: 16px; margin-top: 25px;">
  ...
  <span style="color: #9a3412;">
    Proposals are due by <strong>Friday, June 16, 2023 (JST)</strong>. Acceptance notifications will be sent out by <strong>Sunday, June 18, 2023</strong>.
  </span>
</div>
...
The conference takes place at the <a href="http://www.gero-k.jp/sisetu_guide.php" target="_blank" style="color: #0066cc; font-weight: bold;">Gero Synergy Center ACTIVE</a>. Presentations, practical workshops, and discussions will be held across three primary spaces:
</p>

<!-- VENUE OVERVIEW IMAGES -->
<div style="display: flex; justify-content: center; gap: 16px; flex-wrap: wrap; margin-bottom: 25px;">
  <img src="{{ '/assets/images/Picture-1.jpg' | relative_url }}" alt="Gero Synergy Center ACTIVE Exterior" style="max-width: 100%; width: 380px; height: auto; border-radius: 8px; border: 1px solid #e2e8f0;">
  <img src="{{ '/assets/images/Picture-2.jpg' | relative_url }}" alt="Gero Synergy Center ACTIVE Interior" style="max-width: 100%; width: 380px; height: auto; border-radius: 8px; border: 1px solid #e2e8f0;">
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 16px;">
  ...
  <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 12px; text-align: center;">
    <img src="{{ '/assets/images/Picture-1.png' | relative_url }}" alt="Peapod 1" style="width: 100%; height: auto; border-radius: 6px; margin-bottom: 10px; border: 1px solid #e2e8f0;">
  ...
  <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 12px; text-align: center;">
    <img src="{{ '/assets/images/Picture-2.png' | relative_url }}" alt="Peapod 4" style="width: 100%; height: auto; border-radius: 6px; margin-bottom: 10px; border: 1px solid #e2e8f0;">
  ...
  <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 12px; text-align: center;">
    <img src="{{ '/assets/images/Picture-3.png' | relative_url }}" alt="Peapod 6" style="width: 100%; height: auto; border-radius: 6px; margin-bottom: 10px; border: 1px solid #e2e8f0;">
...
<div style="margin-top: 25px; margin-bottom: 30px;">
  <div style="display: flex; gap: 20px; flex-wrap: wrap; align-items: flex-start;">
    <img src="{{ '/assets/images/image-290x300.png' | relative_url }}" alt="Greg Lewis" style="width: 130px; height: auto; border-radius: 8px; border: 1px solid #e2e8f0;">
...
<div style="margin-bottom: 30px;">
  <div style="display: flex; gap: 20px; flex-wrap: wrap; align-items: flex-start;">
    <img src="{{ '/assets/images/Stephen-Pottinger-200x300.jpg' | relative_url }}" alt="Stephen Pottinger" style="width: 130px; height: auto; border-radius: 8px; border: 1px solid #e2e8f0;">
    <div style="flex: 1; min-width: 260px;">
...
Explore facility details at Gero Synergy Center ACTIVE or submit a proposal using the link below:
</p>
